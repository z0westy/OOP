...
namespace Lab_2
{
    ...
    public partial class fMain : Form
    {
        ...
        {
            InitializeComponent();
            figures.addFigure(new Rectangle(new int[] { 10, 10, 50, 74 }));
            figures.addFigure(new Square(new int[] { 250, 250, 450, 450 }));
            figures.addFigure(new Triangle(new int[] { 700, 700, 850, 850, 900, 700 }));
            figures.addFigure(new Ellipse(new int[] { 250, 250, 450, 450 }));
        }
