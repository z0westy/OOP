namespace Lab_2
{
    partial class fMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            msMain.Items.AddRange(new ToolStripItem[] { файлToolStripMenuItem });
            ...
            // 
            файлToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { tsmiOpen, tsmiSaveAs, tsmiImportPlugin });
            ...
            tsmiSaveAs.Size = new Size(266, 26);
            ...
            tsmiImportPlugin.Size = new Size(266, 26);
            tsmiImportPlugin.Text = "Импортировать плагин...";
            tsmiImportPlugin.Click += tsmiImportPlugin_Click;
            // 
            // ofdMain
            // 
            ...
            ofdImportPlugin.Filter = "Плагин|*.dll";
            // 
            // imMain
            // 
